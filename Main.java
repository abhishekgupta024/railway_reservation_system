...
public class Main {
    ...
    private int pnum = 1;
    private int max1 = 75;//ac
    private int max2 = 125;//first
    private int max3 = 175;//sleeper
...
{
System.out.println("#########################################################");
System.out.println("Railway Reservation For Vande Mataram Express");
System.out.println("#########################################################");
}
...
{
System.out.println("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&");
System.out.println("Project done by: Abhishek Gupta & Vivek Kushwah");
System.out.println("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&");
}
}